...
import '../../common/dio_error.dart' as _i18;
import '../../features/add_item/view_models/add_item_vm.dart' as _i3;
import '../../features/categories/view_models/category_vm.dart' as _i16;
...
import '../../features/profile_setup/view_models/delete_item_view_model.dart'
    as _i17;
import '../../features/profile_setup/view_models/inventory_vm.dart' as _i20;
import '../../features/profile_setup/view_models/map_vm.dart' as _i21;
...
import '../../features/signin/view_models/forget_password_vm.dart' as _i19;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.AddItemBottomSheetViewModel>(() =>
      _i15.AddItemBottomSheetViewModel(
          get<_i6.Dio>(),
          get<_i4.SnackbarService>(),
          get<_i4.NavigationService>(),
          get<_i13.UserDataService>()));
  gh.factory<_i16.CategoryViewModel>(() => _i16.CategoryViewModel(
      get<_i4.NavigationService>(),
      get<_i6.Dio>(),
      get<_i4.SnackbarService>(),
      get<_i13.UserDataService>()));
  gh.factory<_i17.DeleteItemBottomSheetViewModel>(
      () => _i17.DeleteItemBottomSheetViewModel(get<_i4.NavigationService>()));
  gh.lazySingleton<_i18.DioErrorService>(
      () => _i18.DioErrorService(get<_i6.Dio>(), get<_i4.SnackbarService>()));
  gh.factory<_i19.ForgetPasswordViewModel>(() => _i19.ForgetPasswordViewModel(
  ...
  gh.factory<_i20.InventoryViewModel>(() => _i20.InventoryViewModel(
      get<_i4.NavigationService>(),
      get<_i6.Dio>(),
      get<_i13.UserDataService>(),
      get<_i4.SnackbarService>()));
  gh.factory<_i21.MapViewModel>(
      () => _i21.MapViewModel(get<_i4.NavigationService>()));
